  ...
  return (
    <TouchableWithoutFeedback onPress={() => handleDisableKeyboard(Keyboard)}>
      <View style={styles.container}>
        <Modal animationType="none" transparent={true} visible={visModal}>
        ...
        <Text style={styles.subtitleForgot}>
          Ao inserir o teu email enviaremos para você um código de recuperação
          da sua senha
        </Text>
        ...
        {errors.email && (
          <Text style={styles.msgAlertError}>{errors.email?.message}</Text>
        )}

        <TouchableOpacity
          style={styles.ButtonSendCode}
